...
\textbf{Solution:}\\
Let, $H$ represent no of head and $T$ represent no of tails then $X$ can be
\begin{align}
	(H=0,T=6)\Rightarrow X=|0-6|=6\\
	(H=1,T=5)\Rightarrow X=|1-5|=4\\
	(H=2,T=4)\Rightarrow X=|2-4|=2\\
	(H=3,T=3)\Rightarrow X=|3-3|=0\\
	(H=4,T=2)\Rightarrow X=|4-2|=2\\
	(H=5,T=1)\Rightarrow X=|5-1|=4\\
	(H=6,T=1)\Rightarrow X=|6-0|=6
\end{align}
